...
|--------|--------|--------|--------|
| Exam Proctors | [HackerRank](https://www.hackerrank.com/contests/pacise-2026/challenges/exam-proctors) | N/A | [Click for Solution](ExamProctors/ExamProctors.cpp) |
| Mad Scientist | [USACO](https://usaco.org/index.php?page=viewproblem2&cpid=1012) | Bronze - Easy | [Click for Solution](MadScientist/) |
| Movie Festival | [CSES](https://cses.fi/problemset/task/1629) | Silver - Easy (USACO) | [Click for Solution](MovieFestival/MovieFestival.cpp) |
| Out of Place | [USACO](https://usaco.org/index.php?page=viewproblem2&cpid=785) | Bronze - Normal | [Click for Solution](OutOfPlace/OutOfPlace.cpp) |
